...
public abstract class ModUtils{
    ...
    public void PreInitialization(FMLPreInitializationEvent event){
    	this.configFile = StringHelper.parseConfigFile(event.getModConfigurationDirectory(), event.getModMetadata().modId);
     ...
     * @param name String name to use as key in config. Must be unique to category
     * @return
     */
    ...
    public double getDouble(String name, double Default){
        return getDouble(config.CATEGORY_GENERAL, name, Default);
    }
    ...
    public int getInt(String name, int Default){
        return getInt(config.CATEGORY_GENERAL, name, Default);
    }
    ...
    public boolean getBoolean(String name, boolean Default){
        return getBoolean(config.CATEGORY_GENERAL, name, Default);
    }
    ...
    public static void addSmelting(SimpleItem input, SimpleItem result){
    	addSmelting(input, result, 0F);
    }
    
    public static void addSmelting(SimpleItem input, SimpleItem result, float exp){
    	addSmelting(input, result.getStack(), exp);
    }
    
    public static void addSmelting(SimpleItem input, ItemStack result){
    	addSmelting(input, result, 0F);
    }
    
    public static void addSmelting(SimpleItem input, ItemStack result, float exp){
    	addSmelting(input.id, input.meta, result, exp);
    }
    
    public static void addSmelting(int id, int meta, ItemStack result){
    	addSmelting(id, meta, result, 0F);
    }
    
    public static void addSmelting(int id, int meta, ItemStack result, float exp){
    	FurnaceRecipes.smelting().addSmelting(id, meta, result, exp);
    }
    
    public static void registerOre(String name, SimpleItem ore){
