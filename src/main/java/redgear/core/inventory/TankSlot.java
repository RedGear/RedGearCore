...
public class TankSlot extends InvSlot{
	...
	public TankSlot(IInventory inventory, int x, int y, boolean fillSlot, boolean either) {
		super(inventory, x, y);
		this.fillSlot = fillSlot;
		this.either = either;
	}

	public TankSlot(IInventory inventory, int x, int y, boolean fillSlot) { 
		this(inventory, x, y, fillSlot, false);
	}
	
	public TankSlot(IInventory inventory, int x, int y, boolean fillSlot, TransferRule rule) { 
		this(inventory, x, y, fillSlot, false);
