 ...
 * These include a way of storing the direction a tile is facing, a name used for saving, and basic packet and NBT data saving
 * @author Blackhole
 *
 */
...
public abstract class TileEntityGeneric extends TileEntity
{
    ...
    protected ArrayList<ProgressBar> progressBars = new ArrayList<ProgressBar>();
    ...
    /**
     * @return true if this Tile is on the client side. 
     */
    ...
    /**
	 * Called when a player right clicks this tile while holding a Buildcraft wrench
	...
	/**
	 * Called when a player right clicks this tile while holding a Buildcraft wrench and holding shift
	 * @param player The Player who clicked.
	 * @param side The Side the player clicked on
	 * @return true if the gui should open, false if it should not. 
	 */
    ...
    /**
     * Override this function if you have any buttons. This will be called whenever this button is clicked, so do whatever the button does.
     * You can check the currState to see what state it is in now if that is needed.
